...
min_sample_size = int(sys.argv[4])
...
if clustering_algo == "Agglomerative":
    ...
    clustering = DBSCAN(eps=epsilon, min_samples=min_sample_size)
...
# plt.tight_layout()
plt.savefig(f"{kernel_name}_PCA_{clustering_algo}_{epsilon}_{min_sample_size}_motifs.png", dpi=300)
# plt.show()
