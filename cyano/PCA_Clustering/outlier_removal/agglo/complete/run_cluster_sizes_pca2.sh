...
for i in {2..11}; do
    python motifs_clustered_copy.py "Agglomerative" 2 $i "complete" >>Agglomerative_PCA2_"$i".txt
...
#    python motifs_clustered_copy.py "Agglomerative" 6 $i "ward" >>Agglo_PCA6_ward.txt
#
