...
@author: JAS
 ...
 To do: Work on density vmin vmax of colorbar, there are some minimum 
 outlier densities (0.54) that make the colorbar pointless (1.2-1.33) otherwise. 
...
qualitative_colors2 = "viridis" #"plasma"#"spring"
markers = ['o', 'v', '^','>', 's','d', 'h', 'X','.']

s0, s1, s2, s3, s4, s5, s6, s7, s8, m = generate_subsets(pca, feature, ener, clustering)

sorted_dens = ener.sort_values(by="dma_dens", ascending=True)
print(sorted_dens.head())
vmax = ener['dma_dens'].max()
vmin1 = ener['dma_dens'].min()
vmin = 1.20 #15
print(ener['dma_dens'].idxmin())
print("Color ranges: ", vmin, vmax)
# norm = plt.colors.Normalize(vmin=vmin1, vmax=vmax)

fig, ax = plt.subplots(figsize=(11.69,8.27)) #figure(figsize=(8.27, 11.69), dpi=100)
a0 = ax.scatter(s0.pca0, s0.pca1,marker=m[0], c=s0.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="Undefined")
a0.set_clim(vmin,vmax)
a1 = ax.scatter(s1.pca0, s1.pca1,marker=m[1], c=s1.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="T")
a1.set_clim(vmin,vmax)
a2 = ax.scatter(s2.pca0, s2.pca1,marker=m[2], c=s2.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="B")
a2.set_clim(vmin,vmax)
a3 = ax.scatter(s3.pca0, s3.pca1,marker=m[3], c=s3.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="I")
a3.set_clim(vmin,vmax)
a4 = ax.scatter(s4.pca0, s4.pca1,marker=m[4], c=s4.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,B" ) 
a4.set_clim(vmin,vmax)
a5 = ax.scatter(s5.pca0, s5.pca1,marker=m[5], c=s5.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,I")
a5.set_clim(vmin,vmax)
a6 = ax.scatter(s6.pca0, s6.pca1,marker=m[6], c=s6.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="B,I" ) 
a6.set_clim(vmin,vmax)
a7 = ax.scatter(s7.pca0, s7.pca1,marker=m[7], c=s7.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,B,I")
a7.set_clim(vmin,vmax)
a8 = ax.scatter(s8.pca0, s8.pca1,marker=m[8], c=s8.dma_dens, s=35, alpha=0.75, cmap=qualitative_colors2, label="Undefined")
...
cbar.set_label('Density (g cm$^{-1}$)')
plt.savefig(f"{kernel_name}_{n_clusters}_{linkage_criterium}_{clustering_algo}_{n_cut}_c_dens.png", dpi=300)
# plt.show()
...
#%%
# fig, ax = plt.subplots(figsize=(11.69,8.27)) #figure(figsize=(8.27, 11.69), dpi=100)
# ax.scatter(s0.dma_dens, s0.dma_dens,marker=m[0], c=s0.color, s=35, alpha=0.75, cmap=qualitative_colors2, label="Undefined")
