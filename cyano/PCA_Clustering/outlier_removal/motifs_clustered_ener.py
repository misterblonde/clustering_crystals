...
vmax = ener['dma_relat_ener'].max()
vmin = ener['dma_relat_ener'].min()
...
a1 = ax.scatter(s1.pca0, s1.pca1,marker=m[1], c=s1.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="T")
a1.set_clim(vmin,vmax)
a2 = ax.scatter(s2.pca0, s2.pca1,marker=m[2], c=s2.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="B")
a2.set_clim(vmin,vmax)
a3 = ax.scatter(s3.pca0, s3.pca1,marker=m[3], c=s3.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="I")
a3.set_clim(vmin,vmax)
a4 = ax.scatter(s4.pca0, s4.pca1,marker=m[4], c=s4.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,B" ) 
a4.set_clim(vmin,vmax)
a5 = ax.scatter(s5.pca0, s5.pca1,marker=m[5], c=s5.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,I")
a5.set_clim(vmin,vmax)
a6 = ax.scatter(s6.pca0, s6.pca1,marker=m[6], c=s6.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="B,I" ) 
a6.set_clim(vmin,vmax)
a7 = ax.scatter(s7.pca0, s7.pca1,marker=m[7], c=s7.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="T,B,I")
a7.set_clim(vmin,vmax)
a8 = ax.scatter(s8.pca0, s8.pca1,marker=m[8], c=s8.dma_relat_ener, s=35, alpha=0.75, cmap=qualitative_colors2, label="Undefined")
...
cbar.set_label('Relative DMA energy from global minimum (kJ mol$^{-1}$)')
plt.savefig(f"{kernel_name}_{n_clusters}_{linkage_criterium}_{clustering_algo}_{n_cut}_c_ener.png", dpi=300)
# plt.show()
