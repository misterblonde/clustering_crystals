...
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05),
          fancybox=True, shadow=True, ncol=4)
plt.tight_layout()
plt.savefig(f"{kernel_name}_{n_clusters}_W99Edens_{clustering_algo}_motifs601.png", dpi=300)
plt.show()
...
plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05),
          fancybox=True, shadow=True, ncol=4)
plt.tight_layout()
plt.savefig(f"{kernel_name}_{n_clusters}_DFTEdens_{clustering_algo}_motifs601.png", dpi=300)
plt.show()
