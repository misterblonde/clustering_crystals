...
fig, ax = plt.subplots()
plt.scatter(pca.components_[0],pca.components_[1], c=clustering.labels_, s=30, cmap=qualitative_colors, label=clustering.labels_)
...
plt.tight_layout()
plt.savefig(f"{kernel_name}_{n_clusters}_PCA.png", dpi=300)
plt.show()
