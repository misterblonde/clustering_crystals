...
def construct_helicene_graphs():
    ...
    skip = 2
    inp_folder = 'Neighshells' #'Neighshells'#Neighshells'   # dir with xyz to convert into graphs
...
# print(names_list)
# names = [int(elem) for elem in names_list]
# # print(names)
# with open(f"names_list.csv", "w", newline="") as f:
#     writer = csv.writer(f)
#     writer.writerows(names)

#np.savetxt(f"names_list.csv", names_list, delimiter=",")
